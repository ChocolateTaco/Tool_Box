...
def sort_timer(func):
	...
	def wrapper(*args, **kwargs):
		...
		print(f"Total elapsed time: {total_elapsed_time:0.6f} seconds")
...
sorting_alg3=mSortHere, sorting_alg4=selSort, sorting_alg5=shellS):
	...
	while point_count <= point_count_max:
		...
		# between 1 and 10000
		list_2 = list_1.copy() # copy of the first list
		list_3 = list_1.copy()
		list_4 = list_1.copy()
		list_5 = list_1.copy()
	...
	pyplot.plot(x_axis, alg2_ytime, 'go--', linewidth=2,
	            label=f"{sorting_alg2.__name__}")
	pyplot.plot(x_axis, alg3_ytime, 'ro--', linewidth=2,
	            label=f"{sorting_alg3.__name__}")
	pyplot.plot(x_axis, alg4_ytime, 'yo--', linewidth=2, 
	            label=f"{sorting_alg4.__name__}")
	pyplot.plot(x_axis, alg5_ytime, 'bo--', linewidth=2,
