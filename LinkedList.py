...
class LinkedList:
    ...
    def contains(self, value):
        """
        Returns True if the value is found in a list,
        returns False otherwise.
        """
        ...
        while current is not None and current.data != value:
            previous = current
            current = current.next
        # Returns False if it reaches the end of linked list without finding a match, otherwise it returns True. NOT IDEAL THOUGH! Because this goes through an entire list. Should return True ASAP if found.
        # if current is None:
        #     return False
        # else:
        #     return True
